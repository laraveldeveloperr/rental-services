      ...
      <div class="card-body">
        <form class="forms-sample" action="{{ route(ADMIN.'.blogs.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="title" value="{{ old('title') }}" id="title" placeholder="Bloq başlığını daxil edin">
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <textarea id="summernote" name="content" height="300">{{ old('content') }}</textarea>
            </div>
          </div>
