      ...
      <div class="tab-content p-3 border" id="myTabContent">
        ...
        <div class="tab-pane fade {{ $lang_key==0  ? 'show active' : '' }}" id="{{ $lang->shortened }}-pane"
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{ $blog->translate($lang->shortened)->title }}"
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{ $blog->translate($lang->shortened)->slug }}"
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <textarea id="summernote-{{ $lang->shortened }}" name="data[{{ $lang->shortened }}][content]"
                height="300">{{ $blog->translate($lang->shortened)->content }}</textarea>
            </div>
          </div>
        </div>
        @endforeach
