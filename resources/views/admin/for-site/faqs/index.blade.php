...
@section('content')
    <div class="card">
        ...
        <h3>{{ __('faqs') }}
            <div class="float-end">
                @can('create site faqs')
                <a class="btn btn-success btn-xs" href="{{ route(ADMIN.'.faqs.create') }}">
                    <span>
          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <a href="{{ route(ADMIN.'.faqs.edit', $element->id) }}">
                        {{$element->question}}
                    </a>
                </td>
                ...
                <ul class="list-inline">
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="{{ route(ADMIN.'.faqs.edit',  $element->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 icon-sm me-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg> <span class="">{{ __('edit') }}</span></a>
                  </li>
                  @endcan
                  @can('delete site faqs')
                  <li class="list-inline-item">
                      {!! Form::open([
                      'class'=>'delete',
                      'url' => route(ADMIN . '.faqs.destroy',  $element->id),
                      'method' => 'DELETE',
                      ])
                      !!}
