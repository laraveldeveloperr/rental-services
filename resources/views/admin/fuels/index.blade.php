...
@section('content')
    <div class="card">
        ...
        <h3>Yanacaq növləri
            <div class="float-end">
                <a class="btn btn-success btn-xs" href="{{ route(ADMIN.'.fuels.create') }}">
                    <span>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              @foreach($fuels as $type_key => $type)
              <tr>
                <td>
                    {{ $type_key+1 }}
                </td>
                <td>
                    <a href="{{ route(ADMIN.'.fuels.edit', $type->id) }}">
                        {{$type->name}}
                    </a>
                    </td>
