      ...
      <div class="tab-content p-3 border" id="myTabContent">
        ...
        <div class="tab-pane fade {{ $lang_key==0  ? 'show active' : '' }}" id="{{ $lang->shortened }}-pane" role="tabpanel" aria-labelledby="{{ $lang->shortened }}" tabindex="0">
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <textarea id="summernote-{{ $lang->shortened }}" name="data[{{ $lang->shortened }}][description]" height="300"></textarea>
            </div>
          </div>
        </div>
        @endforeach  
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select name="brands_id" class="js-example-basic-single form-select brand-content" id="brands_id">
                ...
                <option value="{{ $brand->id }}" {{ old('brands_id')==$brand->id ? 'selected' : '' }}>{{ $brand->name }}
                </option>
                @endforeach
              </select>
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select name="ban_types_id" class="js-example-basic-single form-select" id="ban_types_id">
                ...
                <option value="{{ $type->id }}" {{ old('ban_types_id')==$type->id ? 'selected' : '' }}>{{ $type->name }}
                </option>
                @endforeach
              </select>
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select name="fuels_id" class="js-example-basic-single form-select" id="fuels_id">
                ...
                <option value="{{ $fuel->id }}" {{ old('fuels_id')==$fuel->id ? 'selected' : '' }}>{{ $fuel->name }}
                </option>
                @endforeach
              </select>
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select name="gears_id" class="js-example-basic-single form-select" id="gears_id">
                ...
                <option value="{{ $gear->id }}" {{ old('gears_id')==$gear->id ? 'selected' : '' }}>{{ $gear->name }}
                </option>
                @endforeach
              </select>
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select name="transmissions_id" class="js-example-basic-single form-select" id="transmissions_id">
                ...
                <option value="{{ $transmission->id }}" {{ old('transmissions_id')==$transmission->id ? 'selected' : '' }}>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select name="engines_id" class="js-example-basic-single form-select" id="engines_id">
                ...
                <option value="{{ $engine->id }}" {{ old('engines_id')==$engine->id ? 'selected' : '' }}>{{ $engine->name }}
                </option>
                @endforeach
              </select>
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select name="cars_faqs_id[]" class="js-example-basic-single form-select" id="cars_faqs_id" multiple>
                ...
                <option value="{{ $element->id }}" {{ old('cars_faqs_id')==$element->id ? 'selected' : '' }}>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="manufacturing_year" value="{{ old('manufacturing_year') }}"
                id="manufacturing_year" placeholder="{{ __('enter_manufacturing_year') }}n">
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select name="colors_id" class="js-example-basic-single form-select" id="colors_id">
                ...
                <option value="{{ $color->id }}" {{ old('colors_id')==$color->id ? 'selected' : '' }}>{{ $color->name }}
                </option>
                @endforeach
              </select>
            </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{ old('day_price') }}" name="day_price" id="day_price"
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{ old('week_price') }}" name="week_price" id="week_price"
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{ old('month_price') }}" name="month_price" id="month_price"
