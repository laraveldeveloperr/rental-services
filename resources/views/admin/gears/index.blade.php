...
@section('content')
    <div class="card">
        ...
        <h3>Ötürücü
            <div class="float-end">
                <a class="btn btn-success btn-xs" href="{{ route(ADMIN.'.gears.create') }}">
                    <span>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              @foreach($gears as $type_key => $type)
              <tr>
                <td>
                    {{ $type_key+1 }}
                </td>
                <td>
                    <a href="{{ route(ADMIN.'.gears.edit', $type->id) }}">
                        {{$type->name}}
                    </a>
                    </td>
