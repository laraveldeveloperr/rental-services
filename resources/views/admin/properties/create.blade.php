...
@section('content')
	...
	<div class="card-header">
      ...
      <div class="card-body">
        <form class="forms-sample" action="{{ route(ADMIN.'.properties.store') }}" method="POST" enctype="multipart/form-data">
			@csrf
          <div class="row mb-3">
            <label for="name" class="col-sm-3 col-form-label">Maşın özəlliyi</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{ old('name') }}" name="name" id="name" placeholder="Maşın özəlliyi daxil edin">
            </div>
          </div>
		  <div class="row mb-3">
