...
@section('content')
    <div class="card">
        ...
        <h3>Maşın özəllikləri
            <div class="float-end">
                <a class="btn btn-success btn-xs" href="{{ route(ADMIN.'.properties.create') }}">
                    <span>
                        <i class="mdi mdi-plus"></i>
                    </span>    
                    Yeni Maşın özəllikləri
                </a>
            </div>
        </h3>
        </div>
        ...
        <div class="table-responsive">
          <table id="dataTableExample" class="table">
            <thead>
              <tr>
                <th>№</th>
                <th>Maşın özəllikləri</th>
                <th>Status</th>
                <th>Əməliyyatlar</th>
              </tr>
            </thead>
            <tbody>
              @foreach($properties as $type_key => $type)
              <tr>
                <td>
                    {{ $type_key+1 }}
                </td>
                <td>
                    <a href="{{ route(ADMIN.'.properties.edit', $type->id) }}">
                        {{$type->name}}
                    </a>
                    </td>
                <td>
