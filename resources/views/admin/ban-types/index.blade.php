...
@section('content')
    <div class="card">
        ...
        <h3>Ban növləri
            <div class="float-end">
                <a class="btn btn-success btn-xs" href="{{ route(ADMIN.'.ban-types.create') }}">
                    <span>
          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <a href="{{ route(ADMIN.'.ban-types.edit', $type->id) }}">
                        {{$type->name}}
                    </a>
                    </td>
