...
@section('content')
	...
	<div class="card-header">
      ...
      <div class="card-body">
        <form class="forms-sample" action="{{ route(ADMIN.'.ban-types.store') }}" method="POST" enctype="multipart/form-data">
			@csrf
          <div class="row mb-3">
            <label for="name" class="col-sm-3 col-form-label">Ban növü</label>
            <div class="col-sm-9">
              <input type="text" value="{{ old('name') }}" class="form-control" name="name" id="name" placeholder="Ban növünü daxil edin">
            </div>
          </div>
		  <div class="row mb-3">
