...
@section('content')
    <div class="card">
        ...
        <h3>Mator həcmi
            <div class="float-end">
                <a class="btn btn-success btn-xs" href="{{ route(ADMIN.'.engines.create') }}">
                    <span>
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              @foreach($engines as $type_key => $type)
              <tr>
                <td>
                    {{ $type_key+1 }}
                </td>
                <td>
                    <a href="{{ route(ADMIN.'.engines.edit', $type->id) }}">
                        {{$type->name}}
                    </a>
                    </td>
                <td>{{ $type->cars_count }} avtomobil</td>
                <td>
