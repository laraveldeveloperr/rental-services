          ...
          <div class="col-lg-9">
              ...
              <div class="row align-items-center">
                <div class="col-lg-6">
                  <div class="d-flex align-items-end mb-2 mb-md-0">
                    <h4 class="me-1 text-danger">{{ __('draft') }}</h4>
                  </div>
                </div>
                <div class="col-lg-6">
              ...
              <div class="d-none d-md-flex align-items-center flex-wrap">
                ...
                <div class="btn-group me-2">
                  ...
                  <div class="dropdown-menu" role="menu">
                    <div class="dropdown-divider"></div><a class="dropdown-item text-danger" href="#">{{ __('delete') }}</a>
                  </div>
                </div>
              </div>
            ...
            <div class="email-list">
              ...
              <div class="email-list-item email-list-item--{{ $message->read == 1 ? 'read' : 'unread' }}">
                ...
                <a href="{{ route(ADMIN.'.messages.edit', $message->id) }}" class="email-list-detail">
                  <div class="content">
