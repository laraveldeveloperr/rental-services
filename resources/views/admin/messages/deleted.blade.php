              ...
              <div class="row align-items-center">
                <div class="col-lg-6">
                  <div class="d-flex align-items-end mb-2 mb-md-0">
                    <h4 class="me-1">Silinən mesajlar</h4>
                  </div>
                </div>
                <div class="col-lg-6">
              ...
              <div class="d-none d-md-flex align-items-center flex-wrap">
                ...
                <div class="btn-group me-2">
                  ...
                  <div class="dropdown-menu" role="menu">
                    <a class="dropdown-item restore-selected" href="#">Geri qaytar</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger delete-selected" href="#">Bazadan sil</a>
                  </div>
                </div>
              </div>
...
<script>
  ...
  $('.restore-selected').on('click', function () {
        ...
        $.ajax({
          url:"{{ route(ADMIN.'.messages.restore-selected') }}",
          method:"POST",
          data: {
            "_token":"{{ csrf_token() }}",
  ...
  $('.delete-selected').on('click', function () {
        ...
        $.ajax({
          url:"{{ route(ADMIN.'.messages.delete-selected') }}",
          method:"POST",
          data: {
            "_token":"{{ csrf_token() }}",
            "selectedMessages":selectedMessages 
