          ...
          <div class="row mb-3" id="car-section">
            ...
            <div class="col-sm-5">
              <select name="type" class="js-example-basic-single form-select discount-type" id="type">
                <option selected disabled>{{ __('select') }}</option>
                <option value="1" {{ $discount->type == 1 ? 'selected' : '' }}>{{ __('percentage') }}</option>
                <option value="0" {{ $discount->type == 0 ? 'selected' : '' }}>{{ __('flat') }}</option>
              </select>
            </div>
            <div class="col-sm-5">
              <input type="number" name="discount" value="{{ $discount->discount }}" class="form-control" id="discount" placeholder="{{ __('enter_discount') }}">
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <select name="status" class="js-example-basic-single form-select" id="status">
                ...
                <option value="0" {{$discount->status == 0 ? 'selected' : '' }}>{{ __('deactive') }}</option>
              </select>
            </div>
          </div>
